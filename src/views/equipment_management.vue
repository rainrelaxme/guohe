<template>
  <div class="equipmentBox mainBox">
    ...
    >
      <el-form ref="form" :model="form" label-width="80px">
        <div class="item-group">
          <el-form-item label="编号" class="star">
            <el-input v-model="form.number" :disabled="isEditor"></el-input>
          </el-form-item>
          ...
          <el-form-item :label="annex">
            <el-upload class="upload-demo" action="" v-show="!isEditor">
              <el-button size="small" type="success">{{ annexName }}</el-button>
            </el-upload>
            <a href="javascript:;">
              <el-button size="small" type="success" v-show="isEditor"
                >{{ annexName }}
              </el-button>
            </a>
          </el-form-item>

  ...
  <div class="meetingBox mainBox">
    <el-row class="dangerBox main">
      <el-tabs v-model="activeName">
        <el-tab-pane label="所有风险信息" name="1">
        ...
        <el-tab-pane label="我管理的风险" name="2">配置管理</el-tab-pane>
        <el-tab-pane label="我参与的风险" name="3">角色管理</el-tab-pane>
        <el-tab-pane label="草稿" name="4">定时任务补偿</el-tab-pane>
        <el-tab-pane label="废止风险" name="5">定时任务补偿</el-tab-pane>
      </el-tabs>
    </el-row>
    <!-- 新增弹窗 -->
    <el-dialog :title="titleName" :visible.sync="dialogVisible" width="50%">
      <el-form ref="addform" :model="addform" label-width="80px">
        ...
        <div class="item-group">
          ...
          <el-form-item label="风险日期" class="star">
            <div class="block">
              <el-date-picker
    ...
    >
      ...
      <el-row>
        <el-col :md="24" :xs="24" class="item b-b">
          ...
          <span class="tit mr-3">风险变更:</span><span class="blue">2次</span>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
            <span class="tit mr-3">风险名称:</span

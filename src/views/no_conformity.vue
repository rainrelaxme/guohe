<template>
  <div class="meetingBox mainBox">
    <el-row class="unusualBox main">
      <el-tabs v-model="activeName">
        <el-tab-pane label="所有不符合项信息" name="1">
          ...
          <div class="tableBox border">
            ...
            <template>
              ...
              >
                ...
                <el-table-column prop="creater" label="指派"> </el-table-column>
                <el-table-column
                  prop="date"
                  label="更新时间"
                  min-width="120"
                ...
                >
                  <template slot-scope="scope">
                    ...
                    <el-button type="text" @click="solveClick">
                      解决
                    </el-button>
        ...
        <el-tab-pane label="我管理的不符合项" name="2">配置管理</el-tab-pane>
        <el-tab-pane label="我参与的不符合项" name="3">角色管理</el-tab-pane>
        <el-tab-pane label="草稿" name="4">定时任务补偿</el-tab-pane>
        <el-tab-pane label="废止不符合项" name="5">定时任务补偿</el-tab-pane>
        <el-tab-pane label="指派我的不符合项" name="6">指派我的不符合项</el-tab-pane>
      </el-tabs>
    </el-row>
    <!-- 新增弹窗 -->
    <el-dialog :title="titleName" :visible.sync="dialogVisible" @closed="closedDialog" width="55%">
      <el-form ref="addform" :model="addform" label-width="110px">
        <el-form-item label="解决结果" v-show="isSolve">
          <el-select class="w-100" v-model="addform.name" placeholder="请选择结果">
        ...
        <div class="item-group" v-show="!isSolve">
          ...
          <el-form-item label="关联用例" class="star">
        ...
        <div class="item-group" v-show="!isSolve">
          <el-form-item label="不符合项级别" class="star">
            <el-select v-model="addform.name" placeholder="请选择不符合项级别">
              <el-option label="子项目1" value="1"></el-option>
              <el-option label="子项目2" value="2"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="不符合项类型" class="star">
            <el-select v-model="addform.name" placeholder="请选择不符合项类型">
              <el-option label="子项目1" value="1"></el-option>
              <el-option label="子项目2" value="2"></el-option>
            </el-select>
          </el-form-item>
        ...
        <div class="item-group" v-show="!isSolve">
          <el-form-item label="操作系统" class="star">
            <el-select v-model="addform.name" placeholder="请选择操作系统">
              <el-option label="子项目1" value="1"></el-option>
              <el-option label="子项目2" value="2"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="浏览器" class="star">
            <el-select v-model="addform.name" placeholder="请选择浏览器">
              <el-option label="子项目1" value="1"></el-option>
              <el-option label="子项目2" value="2"></el-option>
            </el-select>
          </el-form-item>
        ...
        <div class="item-group" v-show="!isSolve">
          ...
          <el-form-item label="不符合项日期" class="star">
            <div class="block">
              <el-date-picker
        ...
        <el-form-item label="复现步骤" v-show="!isSolve">
        ...
        <el-form-item label="上传附件" class="m-0">
          ...
          <el-checkbox class="ml-3" v-model="addform.desc" v-show="isEdit || isSolve"
            >设为基准线</el-checkbox
          >
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="small" type="success" @click="saveClick" v-show="!isSolve"
          >存为草稿</el-button
        >
    ...
    >
      ...
      <el-row>
        <el-col :md="24" :xs="24" class="item b-b">
          ...
          <span class="tit mr-3">不符合项变更:</span><span class="blue">2次</span>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
            <span class="tit mr-3">不符合项名称:</span
        ...
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
            <span class="tit mr-3">不符合项级别:</span
            ><span>XXX安全仪表项目开发</span>
          </p>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p><span class="tit mr-3">不符合项类型:</span><span>需求</span></p>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
        ...
        <el-col :md="24" :xs="24" class="item b-b">
          <p><span class="tit mr-3">操作步骤:</span><span>这是操作步骤</span></p>
        </el-col>
        <el-col :md="24" :xs="24" class="item b-b">

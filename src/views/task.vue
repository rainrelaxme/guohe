  ...
  <div class="meetingBox mainBox">
    <el-row class="actionItemBox main">
      <el-tabs v-model="activeName">
        <el-tab-pane label="所有任务信息" name="1">
        ...
        <el-tab-pane label="我管理的任务" name="2">配置管理</el-tab-pane>
        <el-tab-pane label="我参与的任务" name="3">角色管理</el-tab-pane>
        <el-tab-pane label="草稿" name="4">定时任务补偿</el-tab-pane>
        <el-tab-pane label="废止任务" name="5">定时任务补偿</el-tab-pane>
      </el-tabs>
    </el-row>
    <!-- 新增弹窗 -->
    <el-dialog
    ...
    >
      <el-form ref="addform" :model="addform" label-width="90px">
        ...
        >
          <el-select v-model="addform.class" placeholder="请选择一级任务">
    ...
    >
      ...
      <el-row>
        <el-col :md="24" :xs="24" class="item b-b">
          ...
          <span class="tit mr-3">任务变更:</span><span class="blue">2次</span>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
            <span class="tit mr-3">任务名称:</span

<template>
  <div class="meetingBox mainBox">
    <el-row class="actionItemBox main">
      <el-tabs v-model="activeName">
        <el-tab-pane label="所有行动项信息" name="1">
        ...
        <el-tab-pane label="我管理的行动项" name="2">配置管理</el-tab-pane>
        <el-tab-pane label="我参与的行动项" name="3">角色管理</el-tab-pane>
        <el-tab-pane label="草稿" name="4">定时任务补偿</el-tab-pane>
        <el-tab-pane label="废止行动项" name="5">定时任务补偿</el-tab-pane>
      </el-tabs>
    </el-row>
    <!-- 新增弹窗 -->
    <el-dialog
    ...
    >
      <el-form ref="addform" :model="addform" label-width="90px">
        ...
        <el-form-item label="所属项目" class="star" v-show="!isCreate">
          <el-select
        ...
        <el-form-item
          label="所属行动项"
          v-show="isCreate"
          class="createActionBox multiple-item"
        >
          <el-select v-model="addform.class" placeholder="请选择一级行动项">
            <el-option label="测试与验证中心" value="1"></el-option>
            <el-option label="研发中心" value="2"></el-option>
          </el-select>
          <el-select
            v-model="addform.secondClass"
            placeholder="请选择二级行动项"
            v-if="addform.class"
            class="ml-2"
          >
        ...
        <div class="item-group">
          ...
          <el-form-item label="计划日期" class="star">
            <div class="block">
              <el-date-picker
    ...
    >
      ...
      <el-row>
        <el-col :md="24" :xs="24" class="item b-b">
          ...
          <span class="tit mr-3">行动项变更:</span><span class="blue">2次</span>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
            <span class="tit mr-3">行动项名称:</span

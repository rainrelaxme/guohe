  ...
  <div class="meetingBox mainBox">
    <el-row class="unusualBox main">
      <el-tabs v-model="activeName">
        <el-tab-pane label="所有异常信息" name="1">
        ...
        <el-tab-pane label="我管理的异常" name="2">配置管理</el-tab-pane>
        <el-tab-pane label="我参与的异常" name="3">角色管理</el-tab-pane>
        <el-tab-pane label="草稿" name="4">定时任务补偿</el-tab-pane>
        <el-tab-pane label="废止异常" name="5">定时任务补偿</el-tab-pane>
        <el-tab-pane label="指派我的异常" name="6">指派我的异常</el-tab-pane>
      </el-tabs>
    </el-row>
    <!-- 新增弹窗 -->
    <el-dialog :title="titleName" :visible.sync="dialogVisible" @closed="closedDialog" width="50%">
      <el-form ref="addform" :model="addform" label-width="80px">
        ...
        <div class="item-group" v-show="!isSolve">
          <el-form-item label="异常级别" class="star">
            <el-select v-model="addform.name" placeholder="请选择异常级别">
              <el-option label="子项目1" value="1"></el-option>
              <el-option label="子项目2" value="2"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="异常类型" class="star">
            <el-select v-model="addform.name" placeholder="请选择异常类型">
              <el-option label="子项目1" value="1"></el-option>
              <el-option label="子项目2" value="2"></el-option>
            </el-select>
          </el-form-item>
        ...
        <div class="item-group" v-show="!isSolve">
          ...
          <el-form-item label="异常日期" class="star">
            <div class="block">
              <el-date-picker
    ...
    >
      ...
      <el-row>
        <el-col :md="24" :xs="24" class="item b-b">
          ...
          <span class="tit mr-3">异常变更:</span><span class="blue">2次</span>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
            <span class="tit mr-3">异常名称:</span
        ...
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
            <span class="tit mr-3">异常级别:</span
            ><span>XXX安全仪表项目开发</span>
          </p>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p><span class="tit mr-3">异常类型:</span><span>需求</span></p>
        </el-col>
        <el-col :md="12" :xs="24" class="item b-b">
          <p>
